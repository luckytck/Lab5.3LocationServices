...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLongitudeLabel = getResources().getString(R.string.longitude_labe);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
         ...
         */
        private void showSnackbar(final String text) { View container = findViewById(R.id.main_activity_container);
            if (container != null) {
                    ...
                    showSnackbar(R.string.permission_denied_explanation,
                            R.string.settings, new View.OnClickListener() {
                                @Override public void onClick(View view) {
                                    ...
                                    intent.setData(uri); intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
